...
describe('Recipient API tests', async function () {
    ...
    context('List Recipients', function () {
        ...
        it('Should list only recipient with status VALIDADO', async () => {
